...
public final class DolphinMetricKeys {
  ...
  public static final String COMPUTE_TASK_EXCHANGE_PRE_RUN_SHUFFLE_DATA_START =
      "COMPUTE_TASK_EXCHANGE_PRE_RUN_SHUFFLE_DATA_START";
  public static final String COMPUTE_TASK_EXCHANGE_PRE_RUN_SHUFFLE_DATA_END =
      "COMPUTE_TASK_EXCHANGE_PRE_RUN_SHUFFLE_DATA_END";
  public static final String COMPUTE_TASK_EXCHANGE_POST_RUN_SHUFFLE_DATA_START =
      "COMPUTE_TASK_EXCHANGE_POST_RUN_SHUFFLE_DATA_START";
  public static final String COMPUTE_TASK_EXCHANGE_POST_RUN_SHUFFLE_DATA_END =
      "COMPUTE_TASK_EXCHANGE_POST_RUN_SHUFFLE_DATA_END";
