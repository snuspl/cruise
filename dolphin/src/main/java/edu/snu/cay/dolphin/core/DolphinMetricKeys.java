...
public final class DolphinMetricKeys {
  ...
  public static final String COMPUTE_TASK_EXCHANGE_SHUFFLE_DATA_START =
      "METRIC_COMPUTE_TASK_EXCHANGE_SHUFFLE_DATA_START";
  public static final String COMPUTE_TASK_EXCHANGE_SHUFFLE_DATA_END =
      "METRIC_COMPUTE_TASK_EXCHANGE_SHUFFLE_DATA_END";
