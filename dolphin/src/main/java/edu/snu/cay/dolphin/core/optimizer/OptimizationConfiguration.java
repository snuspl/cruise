...
import edu.snu.cay.services.em.optimizer.impl.NoOperationOptimizer;
...
public final class OptimizationConfiguration {
  ...
  /**
   * @return a configuration with NoOperationOptimizer and LoggingPlanExecutor
   */
  public static Configuration getNoOperationOptimizerConfiguration() {
    return Tang.Factory.getTang().newConfigurationBuilder()
        .bindImplementation(Optimizer.class, NoOperationOptimizer.class)
        .bindImplementation(PlanExecutor.class, LoggingPlanExecutor.class)
        .build();
  }
}
