  ...
  public static void main(final String[] args) throws Exception {
    DolphinLauncher.run(
        Configurations.merge(
            DolphinConfiguration.getConfiguration(args, SleepParameters.getCommandLine()),
            Tang.Factory.getTang().newConfigurationBuilder()
                .bindNamedParameter(JobIdentifier.class, "SleepREEF")
                .bindImplementation(UserJobInfo.class, SleepJobInfo.class)
                .bindImplementation(UserParameters.class, SleepParameters.class)
                .build()));
  }
}
