...
public final class PlanValidationUtils {
   ...
   */
  public static void checkPlan(final String namespace,
                               final Collection<EvaluatorParameters> activeEvaluators,
                               final Plan plan,
                               final int availableEvaluators) {
    final Collection<EvaluatorParameters> applied = applyPlan(namespace, activeEvaluators, plan);
    assertTrue(
   ...
   */
  private static Collection<EvaluatorParameters> applyPlan(final String namespace,
                                                           final Collection<EvaluatorParameters> activeEvaluators,
                                                           final Plan plan) {
