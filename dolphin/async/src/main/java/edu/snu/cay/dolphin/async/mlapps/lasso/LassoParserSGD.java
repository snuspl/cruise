 ...
 * </p>
 */
final class LassoParserSGD implements DataParser<LassoDataSGD> {
  ...
  @Inject
  private LassoParserSGD(final DataSet<LongWritable, Text> dataSet,
  ...
  @Override
  public List<LassoDataSGD> parse() {
    ...
    for (final Pair<LongWritable, Text> keyValue : dataSet) {
      ...
      retList.add(new LassoDataSGD(feature, yValue));
    }
    return retList;
  }
}
