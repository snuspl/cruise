...
# EXAMPLE USAGE
# ./run_addinteger.sh -num_workers 3 -number_workers 3 -number_servers 2 -max_num_epochs 10 -mini_batch_size 10 -delta 4 -num_keys 100 -num_training_data 50 -num_test_data 5 -compute_time_ms 30 -max_num_eval_local 5 -input run_addinteger.sh -optimizer edu.snu.cay.dolphin.async.optimizer.EmptyPlanOptimizer -optimization_interval_ms 3000 -delay_after_optimization_ms 10000 -server_metric_flush_period_ms 1000
