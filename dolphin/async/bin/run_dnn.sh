...
# EXAMPLE USAGE 
# ./run_dnn.sh -local true -max_iter 100 -conf dnn_conf/sample_dnn_conf -input sample_dnn_data -split 2 -max_num_eval_local 3 -num_worker_threads 1 -timeout 800000 -dynamic false
