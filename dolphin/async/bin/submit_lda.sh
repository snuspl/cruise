...
# EXAMPLE USAGE
# ./submit_lda.sh -input sample_lda -num_workers 4 -number_servers 2 -num_topics 10 -num_vocabs 17935 -max_num_epochs 3 -mini_batch_size 25 -num_worker_blocks 20 -server_metric_flush_period_ms 1000
