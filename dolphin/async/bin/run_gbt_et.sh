...
# ./run_gbt_et.sh -num_workers 2 -number_servers 1 -max_num_epochs 300 -mini_batch_size 5000 -features 30 -max_num_eval_local 3 -input sample_gbt_student_score -local true -timeout 200000 -init_step_size 0.05 -lambda 0.5 -gamma 0.5 -max_depth_of_tree 8 -leaf_min_size 3 -metadata_path file://$(PWD)/sample_gbt_student_score.meta -num_keys 5 -server_metric_flush_period_ms 5000
