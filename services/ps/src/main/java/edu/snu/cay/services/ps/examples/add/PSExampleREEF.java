...
/**
 * PS example for demonstrating the capabilities of the parameter server.
 */
public final class PSExampleREEF {
  private static final Logger LOG = Logger.getLogger(PSExampleREEF.class.getName());
  ...
  @Inject
  private PSExampleREEF(@Parameter(JobTimeout.class) final long timeout,
  ...
  private static PSExampleREEF parseCommandLine(final String[] args) throws IOException, InjectionException {
    ...
    return Tang.Factory.getTang().newInjector(cb.build()).getInstance(PSExampleREEF.class);
  }

  public static void main(final String[] args) {
    LauncherStatus status;
    try {
      final PSExampleREEF singleNodePSExampleREEF = parseCommandLine(args);
