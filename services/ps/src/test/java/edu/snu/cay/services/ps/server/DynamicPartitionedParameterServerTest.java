...
/**
 * Tests for {@link DynamicPartitionedParameterServer}.
 */
public final class DynamicPartitionedParameterServerTest {
  ...
  /**
   * Mocked reply sender to instantiate DynamicPartitionedParameterServer.
   */
