...
/**
 * An Optimizer implementation that creates a plan with no operation.
 */
public final class NoOperationOptimizer implements Optimizer {

  @Inject
  private NoOperationOptimizer() {
