...
public interface EMMsgSender {
  ...
  /**
   * Sends a OwnershipCacheInitReqMsg that tells the driver to reply with the up-to-date global routing table.
   * Include {@code parentTraceInfo} to continue tracing this message.
   */
  void sendOwnershipCacheInitReqMsg(@Nullable TraceInfo parentTraceInfo);

  /**
   * Sends a OwnershipCacheInitMsg that contains the up-to-date global routing table {@code blockLocations}.
