...
import static edu.snu.spl.cruise.services.et.examples.checkpoint.PutTask.NUM_ITEMS;
import static edu.snu.spl.cruise.services.et.examples.checkpoint.PutTask.VALUE_PREFIX;
