...
import edu.snu.spl.cruise.services.et.driver.impl.*;
...
public final class ETDriverConfiguration extends ConfigurationModuleBuilder {
  ...
  public static final OptionalImpl<TaskletCustomMsgHandler> TASKLET_CUSTOM_MSG_HANDLER = new OptionalImpl<>();
  ...
  public static final ConfigurationModule CONF = new ETDriverConfiguration()
      ...
      .bindImplementation(TaskletCustomMsgHandler.class, TASKLET_CUSTOM_MSG_HANDLER)
