...
public interface ShuffleTupleMessageGenerator<K, V> {
   ...
   * returned tuple is the receiver id and the value is a merged ShuffleTupleMessage
   * including all tuples to the same receiver. The tuples are classified by the ShuffleStrategy
   * of the shuffle.
   *
   * @param tuple a tuple
   * @return the list of (receiver identifier, ShuffleTupleMessage) tuples
   */
