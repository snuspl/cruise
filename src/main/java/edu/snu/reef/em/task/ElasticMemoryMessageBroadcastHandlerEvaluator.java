 ...
 */
@EvaluatorSide
public final class ElasticMemoryMessageBroadcastHandlerEvaluator implements EventHandler<AvroElasticMemoryMessage> {
  private static final Logger LOG = Logger.getLogger(ElasticMemoryMessageBroadcastHandlerEvaluator.class.getName());
  ...
  @Inject
  private ElasticMemoryMessageBroadcastHandlerEvaluator(final MemoryStore memoryStore,
  ...
  public void onNext(final AvroElasticMemoryMessage msg) {
    LOG.entering(ElasticMemoryMessageBroadcastHandlerEvaluator.class.getSimpleName(), "onNext", msg);
    ...
    LOG.exiting(ElasticMemoryMessageBroadcastHandlerEvaluator.class.getSimpleName(), "onNext", msg);
  }
