...
import edu.snu.spl.cruise.ps.plan.impl.EmptyPlan;
import edu.snu.spl.cruise.ps.plan.impl.PlanImpl;
import edu.snu.spl.cruise.ps.plan.api.Plan;
import edu.snu.spl.cruise.ps.plan.impl.TransferStepImpl;
...
public final class HomogeneousOptimizer implements Optimizer {
  ...
  @Inject
  private HomogeneousOptimizer(@Parameter(CruisePSParameters.NumTotalMiniBatches.class) final int numTotalMiniBatches,
