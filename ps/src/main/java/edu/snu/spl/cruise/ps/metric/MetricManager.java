...
import edu.snu.spl.cruise.ps.dashboard.DashboardConnector;
import edu.snu.spl.cruise.ps.optimizer.impl.ServerEvaluatorParameters;
import edu.snu.spl.cruise.ps.optimizer.impl.WorkerEvaluatorParameters;
import edu.snu.spl.cruise.ps.optimizer.api.EvaluatorParameters;
import edu.snu.spl.cruise.ps.optimizer.impl.DataInfoImpl;
import edu.snu.spl.cruise.ps.optimizer.parameters.NumInitialBatchMetricsToSkip;
...
public final class MetricManager {
  ...
  /**
   * Checks whether the source of the metrics exists in the {@link edu.snu.spl.cruise.services.et.driver.api.ETMaster}'s
   * executor list.
   ...
   * @return {@code true} if the source exists in the {@link edu.snu.spl.cruise.services.et.driver.api.ETMaster}'s view.
   */
