...
/**
 * Cruise-PS specific parameters.
 */
public final class CruisePSParameters {
  @NamedParameter(doc = "Cruise-ps job identifier", default_value = "cruise-ps")
  public final class CruisePSJobId implements Name<String> {
  }
