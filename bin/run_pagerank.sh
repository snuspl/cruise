...
# EXAMPLE USAGE
# ./run_pagerank.sh -maxIter 10 -dampingFactor 0.85 -local true -split 1 -input sample_pagerank -output output_pagerank
...
ALG=edu.snu.reef.dolphin.examples.ml.algorithms.pagerank.PageRankREEF
