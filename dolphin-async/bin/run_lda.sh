...
# EXAMPLE USAGE 
# ./run_lda.sh -input sample_lda -local true -split 6 -numServers 2 -numTopics 10 -numVocabs 102656 -maxIter 1 -maxNumEvalLocal 8 -numWorkerThreads 1 -timeout 300000
